...
class LedgerServiceTest {
    ...
    void deposit_DuplicateTransaction() {
        ...
        Account account = new Account(new AccountNumber(accountNumber), 123456, new BigDecimal("100.00"));
        accounts.put(accountNumber, account);
       ...
       var exception =  assertThrows(DuplicateTransactionException.class, () ->
                ledgerService.deposit(new AccountNumber(accountNumber), transactionId, amount, "Duplicate deposit")
        );
    ...
    void deposit_FirstTransactionForAccount() {
        ...
        // When
        ledgerService.deposit(new AccountNumber(accountNumber), transactionId, depositAmount, "First deposit");
    ...
    void withdraw_InsufficientFunds() {
        ...
        assertThrows(InsufficientFundsException.class, () ->
                ledgerService.withdraw(new AccountNumber(accountNumber), transactionId, withdrawAmount, "Test withdrawal")
        );
    ...
    void withdraw_ExactBalance() {
        ...
        // When
        ledgerService.withdraw(new AccountNumber(accountNumber), transactionId, withdrawAmount, "Withdraw all");
    ...
    void withdraw_DuplicateTransaction() {
        ...
        assertThrows(DuplicateTransactionException.class, () ->
                ledgerService.withdraw(new AccountNumber(accountNumber), transactionId, amount, "Duplicate withdrawal")
        );
    ...
    void multipleTransactions_BalanceConsistency() {
        ...
        ledgerService.deposit(new AccountNumber(accountNumber), UUID.randomUUID(), new BigDecimal("50.00"), "Deposit 1");
        ledgerService.withdraw(new AccountNumber(accountNumber), UUID.randomUUID(), new BigDecimal("30.00"), "Withdraw 1");
        ledgerService.deposit(new AccountNumber(accountNumber), UUID.randomUUID(), new BigDecimal("20.00"), "Deposit 2");
